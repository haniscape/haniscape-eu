...
<footer className="d-flex flex-wrap justify-content-between align-items-center py-3 m-4 border-top">
    <div className="col-md-4 d-flex align-items-center">
      ...
      <span className="mb-3 mb-md-0 text-muted">©2023 Haniscape Import & Export Establishment</span>
    ...
    <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
      ...
      <li className="ms-3"><a className="text-muted" href="https://www.facebook.com/haniscape.eu"><Facebook width="26" height="26" /></a></li>
    </ul>
